...
class NavigationTreeGrid extends Grid
{
    ...
    protected function setup()
    {
        ...
        $this->addAction(trans('motor-cms::backend/navigation_trees.show_nodes'), 'backend.navigations.index', ['class' => 'btn-default']);
        $this->addEditAction(trans('motor-backend::backend/global.edit'), 'backend.navigation_trees.edit')->onCondition('parent_id', null);
        $this->addDeleteAction(trans('motor-backend::backend/global.delete'), 'backend.navigation_trees.destroy')->onCondition('parent_id', null);
    }
}
