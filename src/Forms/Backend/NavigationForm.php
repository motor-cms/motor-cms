...
class NavigationForm extends Form
{
    public function buildForm()
    {
        $this
            ...
            ->add('page_id', 'select2', ['label' => trans('motor-cms::backend/pages.page'), 'empty_value' => trans('motor-backend::backend/global.please_choose'), 'choices' => Page::all()->pluck('name', 'id')->toArray()])
